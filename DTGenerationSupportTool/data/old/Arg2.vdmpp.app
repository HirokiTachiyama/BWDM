new OmlDocument("../data/Arg2.vdmpp",
              ...
              new OmlFunctionBody(
                new OmlIfExpression(
                  ...
                  new OmlIfExpression(
                    ...
                    new OmlSymbolicLiteralExpression(new OmlTextLiteral("-1<a<=10",9,11),9,11),
                    [
                      new OmlElseIfExpression(
                        new OmlBracketedExpression(new OmlBinaryExpression(
                          ...
                          new OmlSymbolicLiteralExpression(new OmlNumericLiteral(5,10,18),10,18),
                          10,
                          16
                        ),10,13),
                        new OmlSymbolicLiteralExpression(new OmlTextLiteral("a<=-1 & 5<b",11,9),11,9),
                        10,
                        7
                      )
                    ],
                    new OmlSymbolicLiteralExpression(new OmlTextLiteral("a<=-1 & b<=5",13,5),13,5),
                    8,
                    10
                  ),
                  [
                  ...
                  new OmlIfExpression(
                    new OmlBracketedExpression(new OmlBinaryExpression(
                      ...
                      new OmlBinaryOperator(2,15,16),
                      new OmlUnaryExpression(
                        new OmlUnaryOperator(15,15,18),
                        new OmlSymbolicLiteralExpression(new OmlNumericLiteral(3,15,19),15,19),
                        15,
                        18
                      ),
                      15,
                    ...
                    new OmlSymbolicLiteralExpression(new OmlTextLiteral("10<a & b<-3",16,12),16,12),
                    [
                      new OmlElseIfExpression(
                        new OmlBracketedExpression(new OmlBinaryExpression(
                          new OmlName(
                        ...
                        new OmlSymbolicLiteralExpression(new OmlTextLiteral("10<a<20 & -3<=b",18,12),18,12),
                        17,
                        10
                      )
                    ],
                    new OmlSymbolicLiteralExpression(new OmlTextLiteral("20<=a & -3<=b",20,5),20,5),
                    15,
                    10
                  ),
                  7,
  ...
  [
    ...
    new OmlLexem(18,12,437,"\"10<a<20 & -3<=b\"",0),
    new OmlLexem(19,3,296,"else",1),
    new OmlLexem(20,5,437,"\"20<=a & -3<=b\"",0),
    new OmlLexem(20,20,59,";",0),
